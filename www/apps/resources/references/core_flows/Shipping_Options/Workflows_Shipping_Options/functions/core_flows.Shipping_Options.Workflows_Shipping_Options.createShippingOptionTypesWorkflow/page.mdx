...
This is available starting from Medusa `v2.10.0`.

:::

<SourceCodeLink link="https://github.com/olivermrbl/medusa/blob/37fa2f9a1ed9a384d297ad787e5589c4b01bf258/packages/core/core-flows/src/shipping-options/workflows/create-shipping-option-types.ts#L58" />
